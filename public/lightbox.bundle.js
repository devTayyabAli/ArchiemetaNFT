  ...
  var t = {
      ...
      4626: function (t, e, i) {
        ...
        const n = i(4147),
          ...
          h = "modal",
          f = "Escape",
          m = { backdrop: !0, keyboard: !0, focus: !0 },
          g = {
        ...
        class A extends c.default {
          ...
          hide() {
            ...
            t && (this._isTransitioning = !0),
              ...
              o.default.off(this._element, _),
              o.default.off(this._dialog, v),
              this._queueCallback(() => this._hideModal(), this._element, t);
          }
          dispose() {
            [window, this._dialog].forEach((t) =>
              o.default.off(t, ".bs.modal")
            ),
          ...
          _setResizeEvent() {
            this._isShown
              ? o.default.on(window, p, () => this._adjustDialog())
              : o.default.off(window, p);
          }
          _hideModal() {
          ...
          _showBackdrop(t) {
            o.default.on(this._element, _, (t) => {
          ...
          static jQueryInterface(t, e) {
            return this.each(function () {
              const i = A.getOrCreateInstance(this, t);
              if ("string" == typeof t) {
                if (void 0 === i[t])
      ...
      7908: function (t, e, i) {
        ...
        (a.allowedEmbedTypes = [
          ...
          (a.initialize = function (t) {
            t.preventDefault(), new a(this).show();
          }),
          document
